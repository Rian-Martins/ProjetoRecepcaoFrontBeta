...
const baseUrl = "https://localhost:44388/api/alunosreposicao/listarrepo";
const creUrl = "https://localhost:44388/api/alunosreposicao/criarrep";
const editUrl = id => `https://localhost:44388/api/alunosreposicao/atualizarrepo/${id}`;
const delUrl = id => `https://localhost:44388/api/alunosreposicao/deletarrepo/${id}`;

const pedidoGetRematricula = async (setData, setOriginalData) => {
    try {
...
const formatDate = (date) => {
  ...
  const pedidoPostRematricula = async (alunoSelecionado, setData, abrirFecharModalIncluir) => {
    try {
  ...
  const pedidoPutRematricula = async (AlunoSelecionado, setData, abrirFecharModalEditar) => {
    try {
    ...
    // const pedidoDeleteRematricula = async (id, setData, abrirFecharModalExcluir) => {
   ...
   export { baseUrl, creUrl, editUrl, delUrl, pedidoGetRematricula, pedidoPostRematricula, pedidoPutRematricula, /*pedidoDeleteRematricula*/ };